! function (e, t) {
      ...
      if (!g) {
        ...
        (g = $(e, (o = h, a = 0 < (r = u).length, l = 0 < o.length, d = function (e, t, n, s, d) {
          ...
          if (y += m, a && m !== y) {
            ...
            if (e) {
              if (0 < y)
                for (; m--;) w[m] || b[m] || (b[m] = L.call(s));
              b = ke(b)
            }
            H.apply(s, b), d && !e && 0 < b.length && 1 < y + r.length && ae.uniqueSort(s)
          }
          return d && (k = S, c = x), w
        }, a ? ce(d) : d))).selector = e
      }
  ...
  (x.fn.init = function (e, t, n) {
    ...
    if (n = n || L, "string" == typeof e) {
      ...
      if (o[1]) {
        if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), j.test(o[1]) && x.isPlainObject(t))
  ...
  x.fn.extend({
    ...
    x.fn[e] = function (n, i) {
      ...
      return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = x.filter(i, o)), 1 < this.length && (O[e] || x.uniqueSort(o), H.test(e) && o.reverse()), this.pushStack(o)
    }
  });
  var q = /[^\x20\t\r\n\f]+/g;
  ...
  x.Callbacks = function (e) {
    var t, n;
    e = "string" == typeof e ? (t = e, n = {}, x.each(t.match(q) || [], function (e, t) {
      n[t] = !0
    }), n) : x.extend({}, e);
    var i, o, r, s, a = [],
      l = [],
        ...
        add: function () {
          return a && (o && !i && (c = a.length - 1, l.push(o)), function t(n) {
            x.each(n, function (n, i) {
              v(i) ? e.unique && u.has(i) || a.push(i) : i && i.length && "string" !== w(i) && t(i)
            })
                ...
                var a = this,
                  ...
                  c = function () {
                    ...
                    if (!(t < r)) {
                      ...
                      c = e && ("object" == typeof e || "function" == typeof e) && e.then, v(c) ? o ? c.call(e, s(r, n, M, o), s(r, n, I, o)) : (r++, c.call(e, s(r, n, M, o), s(r, n, I, o), s(r, n, M, n.notifyWith))) : (i !== M && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
                    }
                  },
                  d = o ? c : function () {
                    try {
                      ...
                      x.Deferred.exceptionHook && x.Deferred.exceptionHook(e, d.stackTrace), r <= t + 1 && (i !== I && (a = void 0, l = [e]), n.rejectWith(a, l))
                    }
                  };
  ...
  }), x.ready.then = W.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(x.ready) : (i.addEventListener("DOMContentLoaded", F), e.addEventListener("load", F));
  ...
  function xe(e, t, n, i, o) {
    for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
      ...
      for (s = s || u.appendChild(t.createElement("div")), a = (fe.exec(r) || ["", ""])[1].toLowerCase(), l = ve[a] || ve._default, s.innerHTML = l[1] + x.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
    ...
    add: function (e, t, n, i, o) {
      ...
      if (g)
        for (n.handler && (n = (r = n).handler, o = r.selector), o && x.find.matchesSelector(oe, o), n.guid || (n.guid = x.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
          ...
          }), c = (t = (t || "").match(q) || [""]).length; c--;) f = v = (a = Se.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = x.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = x.event.special[f] || {}, d = x.extend({
          type: f,
          origType: v,
          data: i,
          handler: n,
  ...
  function Ie(e, t, n, i) {
    ...
    var o, r, a, l, c, d, u = 0,
      ...
      g = t[0],
      y = v(g);
    if (y || 1 < p && "string" == typeof g && !h.checkClone && Ne.test(g)) return e.each(function (o) {
      var r = e.eq(o);
    ...
    if (p && (r = (o = xe(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
      ...
      if (l)
        for (d = a[a.length - 1].ownerDocument, x.map(a, qe), u = 0; u < l; u++) c = a[u], he.test(c.type || "") && !Q.access(c, "globalEval") && x.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, {
  ...
  function Be(e, t, n) {
    ...
    return (n = n || We(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = x.style(e, t)), !h.pixelBoxStyles() && Re.test(s) && Fe.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
  }
  ...
  x.extend(x.event, {
    trigger: function (t, n, o, r) {
      ...
      if (a = h = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !kt.test(m + x.event.triggered) && (-1 < m.indexOf(".") && (m = (w = m.split(".")).shift(), w.sort()), d = m.indexOf(":") < 0 && "on" + m, (t = t[x.expando] ? t : new x.Event(m, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = w.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : x.makeArray(n, [t]), f = x.event.special[m] || {}, r || !f.trigger || !1 !== f.trigger.apply(o, n))) {
        if (!r && !f.noBubble && !g(o)) {
          for (c = f.delegateType || m, kt.test(c + m) || (a = a.parentNode); a; a = a.parentNode) y.push(a), l = a;
  ...
  Wt.href = St.href, x.extend({
    ...
    ajax: function (t, n) {
      ...
      var o, r, s, a, l, c, d, u, p, f, h = x.ajaxSetup({}, n),
        v = h.context || h,
      ...
      for (p in (u = x.event && h.global) && 0 == x.active++ && x.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !qt.test(h.type), r = h.url.replace(Ht, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Nt, "+")) : (f = h.url.slice(r.length), h.data && (h.processData || "string" == typeof h.data) && (r += ($t.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(Ot, "$1"), f = ($t.test(r) ? "&" : "?") + "_=" + Ct++ + f), h.url = r + f), h.ifModified && (x.lastModified[r] && S.setRequestHeader("If-Modified-Since", x.lastModified[r]), x.etag[r] && S.setRequestHeader("If-None-Match", x.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && S.setRequestHeader("Content-Type", h.contentType), S.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Rt + "; q=0.01" : "") : h.accepts["*"]), h.headers) S.setRequestHeader(p, h.headers[p]);
  ...
  x.ajaxSetup({
    ...
    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (h.createHTMLDocument ? ((o = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(o)) : t = i), s = !n && [], (r = j.exec(e)) ? [t.createElement(r[1])] : (r = xe([e], t, s), s && s.length && x(s).remove(), x.merge([], r.childNodes)));
    var o, r, s
...
function (e) {
  ...
  $(document).ready(function () {
    $("form").submit(function () {
      return $.ajax({
        ...
        $(".thanks").addClass("is-show"), $(this).find("input").val(""), $("form").trigger("reset"), $(".js-modal").removeClass("is-show"), $(".js-modal-overlay").removeClass("is-show"), $(".desktop").removeClass("js-no-scroll")
      }), !1
    })
  }), $(".js-open-modal").click(function (e) {
    e.preventDefault();
    var t = $(this).attr("data-modal");
    $('.js-modal[data-modal="' + t + '"]').addClass("is-show"), $(".js-modal-overlay").addClass("is-show"), $(".desktop").addClass("js-no-scroll")
  }), $(".js-modal-close").click(function () {
    $(".js-modal").removeClass("is-show"), $(".js-modal-overlay").removeClass("is-show"), $(".desktop").removeClass("js-no-scroll")
  }), $(".js-modal-overlay").click(function () {
    $(".js-modal.is-show").removeClass("is-show"), $(".desktop").removeClass("js-no-scroll"), $(this).removeClass("is-show")
  });
  ...
  e.forEach(function (e) {
    e.addEventListener("click", function (e) {
      ...
      document.querySelector('.js-modal[data-modal="' + n + '"]').classList.add("is-show"), t.classList.add("is-show")
    })
  }), n.forEach(function (e) {
    e.addEventListener("click", function () {
      this.parentNode.classList.remove("is-show"), t.classList.remove("is-show")
    })
  })
}), $("#slider").slick({
  dots: !0,
